...
def parameter_parser():
    ...
    parser.add_argument(
        "--ratio1", type=float, default=1.0, help="Pooling rate. Default is 0.8."
    )

    parser.add_argument(
        "--ratio2", type=float, default=1.0, help="Pooling rate. Default is 0.8."
    )

    parser.add_argument(
        "--ratio3", type=float, default=0.8, help="Pooling rate. Default is 0.8."
    )
    ...
    parser.add_argument(
        "--device", type=str, default="cuda:0", help="Specify cuda devices"
    )
    ...
    parser.add_argument(
        "--k", type=int, default=5, help="Hyperparameter for construction hyperedge"
    )
